...
- fix: prevent stale message hover updates after unmount

- fix: scope selection toolbars to their owning thread
...
- fix(react): attach the ExportMarkdown download anchor to the document so Firefox starts the download
