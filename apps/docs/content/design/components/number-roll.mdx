...
This adds a `/components/ui/number-roll.tsx` file to your project, which you can adjust as needed. The component has no dependencies beyond React.
...
- [Context Display](/elements/context-display) - Live token usage ring and bar
- [Message Timing](/elements/message-timing) - Streaming stats badge
- [Badge](/design/components/badge) - Small status and metadata labels
