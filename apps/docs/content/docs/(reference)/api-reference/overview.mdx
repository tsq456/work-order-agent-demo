...
<Cards>
  ...
  <Card title="Integrations" href="/docs/api-reference/integrations/ai-sdk">
    Package-level APIs for integrations such as `@assistant-ui/ai-sdk` and `assistant-cloud`.
  </Card>
