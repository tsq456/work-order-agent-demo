...
declare const useLangChainInterrupts: () => readonly {
  id?: string;
  value?: unknown;
}[];
...
declare const useLangChainRespondAll: () => (responsesById: Record<string, unknown>, options?: Record<string, unknown>) => Promise<void>;

declare const useLangChainSend: () => (messages: readonly LangChainBaseMessage[], options?: Record<string, unknown>) => Promise<void>;

declare const useLangChainSendCommand: () => (command: Record<string, unknown>) => Promise<void>;

declare function useLangChainState<T>(key: string): T | undefined;
